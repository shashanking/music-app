  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <div style={{ flex: 1, overflow: 'hidden' }}>
        {tab === 'home' && (
          <HomePage categories={musicApi.categories} allSongs={musicApi.allSongs}
            loading={musicApi.loading} error={musicApi.error} retry={musicApi.loadSongs} />
        )}
        {tab === 'search' && (
          <SearchPage searchResults={musicApi.searchResults}
            searching={musicApi.searching} searchSongs={musicApi.searchSongs} />
        )}
